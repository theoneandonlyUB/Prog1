...
MASTER_URL = rf"https://raw.githubusercontent.com/INBGM0212-2023/exercises/main/week-03/P1033"
...
def run() -> None:
    ...
    for test_id in conf["tests"]:
        ...
        channels = {
            "in": [line.rstrip("\n") + "v" for line in test_case["in"].splitlines()],
            "out": [line.rstrip("\n") + "v" for line in test_case["out"].splitlines()],
            "act": [line.rstrip("\n") + "v" for line in process.stdout.decode("utf-8").splitlines()]
        }
